...
# import các hàm/lớp từ file cuoi_ki.py
...
# Mount router vào app chính
app.include_router(ChildAPI.router)


# Optional: helper gọi nội bộ bằng TestClient
...
# Nếu muốn test nhanh khi chạy trực tiếp file này
